...
using UnityEngine;
using TMPro; // Corrigido o namespace para TMPro

public class PlayerAI3 : PlayerAIBase
{
    protected override void Start()
    {
        base.Start();
        playerLayerName = "Player4Card"; // Defina o nome da camada específica para PlayerAI3
        AdicionarCartaInicial();
        Debug.Log("PlayerAI3 Start - Carta inicial adicionada.");
    }
    ...
    protected void AdicionarCartaInicial()
    {
        ...
        Debug.Log("PlayerAI3 AdicionarCartaInicial - Carta inicial adicionada à mão.");
    }
    ...
    protected void AddCardToHand(GameObject cartaObj)
    {
        ...
        Debug.Log("PlayerAI3 AddCardToHand - Uma carta foi adicionada à mão do jogador. Agora o jogador tem " + hand.Count + " cartas na mão.");
    }
    ...
    {
        Debug.Log("PlayerAI3 FazerDeclaracao - Decidindo declaração.");
        ...
        {
            Debug.LogError("Declaration Text 3D não está atribuído no PlayerAI3.");
        }
    ...
    protected override bool DecidirDeclaracao(List<Cartas> cartasDosOutrosJogadores)
    {
        ...
        {
            Debug.Log("PlayerAI3 DecidirDeclaracao - Declarando Ganhar.");
            return true; // Declarar "Ganhar"
        }
        else
        {
            Debug.Log("PlayerAI3 DecidirDeclaracao - Declarando Perder.");
    ...
    public override IEnumerator JogarTurnoAutomatico()
    {
        ...
        if (hand.Count > 0)
        {
            ...
            if (slotIndex >= 0)
            {
                ...
                Debug.Log("PlayerAI3 JogarTurnoAutomatico - Jogou a carta: " + cartaParaJogar.valoresNumeros + " de " + cartaParaJogar.naipe);
            }
        }
    }
}
